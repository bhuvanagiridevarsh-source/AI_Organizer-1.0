...
// ── PII detection ──────────────────────────────────────────────
// Implementation lives in modules/pii.js so detectors can grow without
// inflating this file.  See <script src="modules/pii.js"> in index.html.
const SSN_REGEX = window.SJ.pii.SSN_REGEX;
const hasPII    = window.SJ.pii.hasPII;

// ── Noun extraction (simple frequency-based) ──────────────────
// STOP_WORDS now sourced from modules/category-evidence.js (single source
// of truth shared with the evidence-keyword extractor below).
const STOP_WORDS = window.SJ.evidence.STOP_WORDS;
...
// Definitions moved to modules/category-evidence.js so new categories can
// be added without scrolling through 5,700 lines of UI code.
const CATEGORY_EVIDENCE = window.SJ.evidence.CATEGORY_EVIDENCE;
